...
import 'package:hms/view/screens/settings/user/appointments_user_hospital_screen.dart';
import 'package:hms/view/widgets/text_utiles.dart';


class MedicalOperationsUserWidget extends StatelessWidget {
  MedicalOperationsUserWidget({Key? key}) : super(key: key);
    ...
    return GetBuilder<AuthController>(
      builder: (_) =>
          Material(
            ...
            child: InkWell(
              onTap: () {
                controller.getAppointmentsUserHospital();

                Get.to(() => const AppointmentsUserHospitalScreen());
              },
