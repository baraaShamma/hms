...
class ProductController extends GetxController {
  ...
  void manageFavourites(int productId) async {
    var existingIndex =
        favouritesList.indexWhere((element) => int.parse(element.id )== productId);
    ...
    if (existingIndex >= 0) {
      ...
      favouritesList
          .add(productList.firstWhere((element) => int.parse(element.id ) == productId));
  ...
  bool isFavourites(int productId) {
    return favouritesList.any((element) => int.parse(element.id ) == productId);
  }
